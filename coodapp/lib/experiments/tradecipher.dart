...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // body: Container( // If using gradient
      ...
      //     ),
      //   ),
      //   child: ListView( // Place ListView inside Container if using gradient
      body: ListView(
        // Removed outer ListView
      ...
      // ), // Close Container if using gradient
    );
  }
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          // Removed duplicate begin: Alignment.topLeft,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ElevatedButton.icon(
                  onPressed: () {},
                  // Removed duplicate icon: parameter
                  icon: const Icon(Icons.arrow_upward_rounded, size: 18),
                  label: const Text('Deposit'),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.greenAccent[700]?.withAlpha(
                      (255 * 0.8).round(),
                    ),
  ...
  Widget _buildActionChip(
    ...
    // Removed duplicate return Container()
    return Container(
      decoration: BoxDecoration(
        color: Theme.of(
          context,
        ...
        boxShadow: [
          BoxShadow(
            color: Colors.black.withOpacity(0.4), // Adjusted shadow
            blurRadius: 8,
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  // Removed duplicate shape: BoxShape.circle,
                ...
                child: Icon(icon, color: color, size: 20), // Added child: Icon
              ),
  ...
  Widget _buildTopMoversList(BuildContext context) {
    // Accept context
  ...
  Widget _buildAssetRow(
    ...
    String symbol,
    String name, // Removed duplicate name
    String price, // Removed duplicate price
    String change,
    Color changeColor,
  ) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          begin: Alignment.centerLeft, // Adjusted gradient start
          end: Alignment.centerRight,
          colors: [
            Theme.of(context).cardColor,
            Theme.of(context).cardColor.withAlpha(
              (255 * 0.8).round(),
            ), // Slightly transparent end
          ],
        ),
        borderRadius: BorderRadius.circular(12),
        // Removed duplicate borderRadius
        boxShadow: [
          BoxShadow(
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      padding: const EdgeInsets.symmetric(
                        horizontal: 6, // Added horizontal padding
                        vertical: 3,
                      ),
                      decoration: BoxDecoration(
                      ...
                      child: Text(
                        // This Text widget displays the change
                        change,
                        style: TextStyle(
                          color: changeColor,
                          fontWeight: FontWeight.bold,
              ...
              ], // Added closing ] for Row children
            ),
          ),
        ),
      ),
  ...
  Widget _buildNewsCard(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(15),
        gradient: LinearGradient(
          begin: Alignment.topLeft, // Adjusted gradient start
          end: Alignment.bottomRight,
          colors: [
            Theme.of(context).cardColor,
        ...
        // Moved boxShadow inside BoxDecoration
        boxShadow: [
          BoxShadow(
            color: Colors.black.withOpacity(0.6),
            blurRadius: 15,
